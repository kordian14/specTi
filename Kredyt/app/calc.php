...
//Sprawdzenie, czy wszystkie zmienne istnieją
...
if (empty( $messages )) {
	...
	// Sprawdzenie czy podane zmienne są numeryczne
	if (! is_numeric( $kwota )) {
...
if (empty ( $messages )) {
	...
	$wynik = $wynik/$rata;
	$wynik = round($wynik, 2); // zaokrąglenie do dwóch liczb po przecinku
